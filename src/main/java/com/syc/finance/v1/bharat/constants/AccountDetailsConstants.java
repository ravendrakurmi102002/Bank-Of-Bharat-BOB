...
public class AccountDetailsConstants {
    ...
    public static final String TWILIO_ACCOUNT_SID = "YOUR_TWILIO_ACCOUNT_SID_HERE";
    public static final String TWILIO_AUTH_TOKEN = "YOUR_TWILIO_AUTH_TOKEN_HERE";
    public static final String TWILIO_PHONE_NUMBER = "YOUR_TWILIO_PHONE_NUMBER_HERE";
